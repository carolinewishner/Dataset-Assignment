...
```{r}
plot(BMI ~ systolic, caroline.dataset)

regrline <- lm(BMI ~ systolic, caroline.dataset)
...
In conclusion, I can note that BMI is positively associated with systolic blood pressure and diastolic blood pressure. It appears to be casually associated.
